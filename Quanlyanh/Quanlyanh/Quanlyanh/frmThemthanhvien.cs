...
namespace Quanlyanh
{
    public partial class frmThemthanhvien : Form
    {
        ...
        private void btnThemthutuc_Click_1(object sender, EventArgs e)
        {
            Connect();
            if (txtMathanhvien.Text == "" ||txtHo.Text=="" ||txtTen.Text =="" || txtDiachi.Text=="")
            {
...
//        {
//            Connect();
//            string sql = @"INSERT INTO Thanhvien values ('NA004',N'Nguyễn',N'Văn A','1545454545',N'nguyenkiem',N'vannguyen@gmail.com')";
